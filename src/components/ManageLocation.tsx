...
import { Input, List, Card, Typography, Row, Col, Button, Drawer } from 'antd';
...
export const ManageLocations: React.FC = () => {
    ...
    const { cities, selectedCity } = useSelector((state: RootState) => state.cities);
